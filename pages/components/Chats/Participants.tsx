...
const Participants = () => {
    ...
    <div className="flex flex-col sm:flex-row justify-between text-black my-2 cursor-pointer hover:bg-gray-100 p-2 hover:rounded-lg">
            <div className="photo px-1 py-2 relative mr-2">
                <Image className="rounded-full w-10 md:w-14 lg:w-14 xl:w-14" src="https://picsum.photos/300/300" alt="Image Photo" width="300" height="300" />
            ...
            <div className="hidden sm:flex sm:flex-row justify-between w-full border-b-2 border-grey-100">
                <div className="profile-section flex flex-col text-left">
                    <span className="font-bold">Namaa</span>
                    <span>Pesan</span>
                </div>
